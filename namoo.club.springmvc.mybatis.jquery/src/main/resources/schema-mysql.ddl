...
VALUES (1, '나무소리', 'namoosori@nextree.co.kr', '1234', 'M', now());

INSERT INTO towner (towner_id, towner_name, email, password, gender, reg_date)
VALUES (2, '홍길동', 'gdhong@nextree.co.kr', '1234', 'M', now());

-- club data
INSERT INTO club (club_id, club_name, description, open_date, admin_id)
VALUES (1, '축구 클럽', '축구를 사랑하는 사람들의 모임', now(), 1);

INSERT INTO club (club_id, club_name, description, open_date, admin_id)
VALUES (2, '농구 클럽', '농구를 사랑하는 사람들의 모임', now(), 2);

INSERT INTO club_member (member_id, club_id, towner_id, towner_email, reg_date)
VALUES ('1-1', 1, 1, 'namoosori@nextree.co.kr', now());

INSERT INTO club_member (member_id, club_id, towner_id, towner_email, reg_date)
VALUES ('2-2', 2, 2, 'gdhong@nextree.co.kr', now());
